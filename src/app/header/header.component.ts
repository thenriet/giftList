...
export class HeaderComponent {
  ...
  ngOnInit(): void {
    this.myForm = this.fb.group({
      ...
      lastname: ['Henriet',  [Validators.required] ],
      age: ['4'],
      genre: ['masculin'],
